...
class CityTest {
  ...
  void find_existsOne() {
    ...
    City result = (City) ICity.find(city1Name);
  ...
  void find_existsTwo() {
    ...
    City result = (City) ICity.find(city2Name);
  ...
  void addLink_empty() {
    ...
    Link link = new TwoWayLink(city1, city2, cityDistanceShort,null);
  ...
  void addLink_notEmpty() {
    ...
    /* note: creating the link calls addLink() */
    Link link2 = new TwoWayLink(city1, city3, cityDistanceLong,null);
  ...
  void getLinksTo_exists() {
    ...
    Link link = new TwoWayLink(city1, city2, cityDistanceShort,null);
    link.setUsed(true);
    Set<Link> routeLinks = new HashSet<>();
